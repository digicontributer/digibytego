...
var crowdin_identifier = 'digibytego'
    ...
    res.on('data', function(chunk) {
      ...
      if (resxml.indexOf('status="skipped"') >= 0) {
        console.log('Translation build was skipped due to either:\n' +
                    ...
                    'Log in to DigiByteGo\'s Crowdin Settings and click the "Build Project" button to assure it is built recently, and then run this ' +
