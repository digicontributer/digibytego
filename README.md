...
DigiByteGo is a secure bitcoin wallet platform for both desktop and mobile devices. DigiByteGo uses [Bitcore Wallet Service](https://github.com/bitpay/bitcore-wallet-service) (BWS) for peer synchronization and network interfacing.
