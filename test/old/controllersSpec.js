...
describe("Unit: Controllers", function() {
  ...
  describe('Send Controller', function() {
    ...
    it('receive from uri using bits', inject(function() {
      sendForm.address.$setViewValue('digibyte:mxf5psDyA8EQVzb2MZ7MkDWiXuAuWWCRMB?amount=1.018085');
      expect(sendForm.amount.$modelValue).to.equal(1018085);
      sendForm.address.$setViewValue('digibyte:mxf5psDyA8EQVzb2MZ7MkDWiXuAuWWCRMB?amount=1.01808500');
      expect(sendForm.amount.$modelValue).to.equal(1018085);
      sendForm.address.$setViewValue('digibyte:mxf5psDyA8EQVzb2MZ7MkDWiXuAuWWCRMB?amount=0.29133585');
    ...
    it('receive from uri using BTC', inject(function($rootScope) {
      ...
      sendForm.address.$setViewValue('digibyte:mxf5psDyA8EQVzb2MZ7MkDWiXuAuWWCRMB?amount=0.1');
  ...
  describe('paymentUriController Controller', function() {
    ...
    beforeEach(inject(function($controller, $rootScope, $location) {
      scope = $rootScope.$new();
      var routeParams = {
        data: 'digibyte:19mP9FKrXqL46Si58pHdhGKow88SUPy1V8'
      };
      var query = {
        amount: 0.1,
    ...
    it('should parse url correctly', function() {
      ...
      scope.pendingPayment.should.equal('digibyte:19mP9FKrXqL46Si58pHdhGKow88SUPy1V8?amount=0.1&message=a digibyte donation');
    });
  });
